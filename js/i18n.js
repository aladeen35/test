...
const I18N_EN = {
  ...
  "تأكد أن زملاءك انضموا بنفس رابط الدعوة، وأنهم سجّلوا زيارات":"Make sure teammates joined with the same invite link and logged visits",
  "تعذّر جلب بيانات الفريق — تحقق من الاتصال":"Could not fetch team data — check your connection",
  ...
  "☁️ المزامنة بين أجهزتك":"☁️ Sync Across Your Devices",
  "تعمل فورًا وبلا حساب: عند التفعيل يُنشأ صندوق سحابي مجاني تلقائيًا وتُزامَن بياناتك مع كل تعديل. انسخ":"Works instantly, no account: enabling creates a free cloud box automatically and syncs on every change. Copy the",
  "رمز المزامنة":"sync code","وأدخله على جهازك الآخر لربطه.":"and enter it on your other device to link it.",
  ...
  "رمز المزامنة — أدخله على أجهزتك الأخرى":"Sync code — enter it on your other devices",
  "⬇️ جلب أحدث نسخة من السحابة":"⬇️ Pull latest from the cloud",
  "لديك رمز من جهازك الأول؟ ألصقه هنا":"Have a code from your first device? Paste it here",
  "🔗 ربط وجلب":"🔗 Link & Pull","📋 نسخ":"📋 Copy",
  "⚙️ خيار متقدم: صندوق JSONBin خاص بمفتاحك":"⚙️ Advanced: private JSONBin box with your key",
  "🔗 ربط / إنشاء صندوق خاص":"🔗 Connect / Create private bin",
  "جارٍ إنشاء صندوقك السحابي المجاني…":"Creating your free cloud box…",
  "تعذّر إنشاء الصندوق — تحقق من الإنترنت وأعد المحاولة":"Couldn't create the box — check your connection and retry",
  "ألصق رمز المزامنة أولاً":"Paste the sync code first",
  "جارٍ الربط والجلب…":"Linking & pulling…",
  "رمز غير صالح أو تعذّر الجلب — تحقق منه":"Invalid code or pull failed — double-check it",
  "نظام الفريق":"Team System",
  "اجمع نتائج زيارات كل الأعضاء في لوحة واحدة — بلا حسابات وبلا مفاتيح:":"Merge every member's visit results into one dashboard — no accounts, no keys:",
  "أنشئ فريقًا":"Create a team","بضغطة واحدة":"in one tap","وشارك":"and share the","رابط الدعوة":"invite link","، وكل من يفتحه ينضم تلقائيًا.":", and anyone who opens it joins automatically.",
  "اسمك (كما سيظهر للفريق)":"Your name (as shown to the team)","مثال: علاء الدين":"e.g. Alaa",
  "✨ إنشاء فريق جديد بضغطة واحدة":"✨ Create a new team in one tap",
  "أو انضم برمز أو رابط دعوة وصلك من قائد الفريق":"Or join with a code or invite link from your team lead",
  "انضمام":"Join","HM… أو رابط الدعوة":"HM… or the invite link",
  "● متصل بالفريق (الوضع المجاني)":"● Connected to the team (free mode)",
  "● متصل بالفريق (صندوق خاص)":"● Connected to the team (private bin)",
  "رمز الدعوة — شاركه مع أعضاء فريقك":"Invite code — share it with your team members",
  "↗ مشاركة رابط الدعوة":"↗ Share invite link","مغادرة الفريق":"Leave team",
  "جارٍ إنشاء فريقك السحابي المجاني…":"Creating your free cloud team…",
  "تعذّر إنشاء الفريق — تحقق من الإنترنت وأعد المحاولة":"Couldn't create the team — check your connection and retry",
  "ألصق رمز أو رابط الدعوة أولاً":"Paste the invite code or link first",
  "جارٍ الانضمام…":"Joining…",
  "رمز دعوة غير صالح أو تعذّر الاتصال":"Invalid invite code or connection failed",
  "تعذّر الجلب — تحقق من الاتصال":"Fetch failed — check your connection",
  "⚙️ خيار متقدم: فريق على JSONBin بمفتاح مشترك":"⚙️ Advanced: team on JSONBin with a shared key",
  ...
  "إنشاء / انضمام بالمفتاح":"Create / Join with key","اختبار الجلب":"Test Fetch",
  "أُنشئ فريق جديد ✓ — شارك رمز الدعوة مع أعضائك":"New team created ✓ — share the invite code with members",
  ...
  "الذكاء يعمل تلقائيًا دون أي إعداد عبر مزوّد مجاني (تسجيل دخول مجاني عند أول رسالة).":"AI works automatically with zero setup via a free provider (free sign-in on your first message).",
  ...
  "تعذّر جلب البيانات — تحقق من الرمز":"Fetch failed — check the code",
...
const I18N_PATTERNS = [
  ...
  [/^● متصل بمفتاحك · (.+)$/, m=>`● Connected with your key · ${m[1]}`],
